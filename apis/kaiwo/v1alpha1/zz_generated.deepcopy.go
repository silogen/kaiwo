...
func (in *CommonStatusSpec) DeepCopyInto(out *CommonStatusSpec) {
	*out = *in
	...
	if in.LastAdmittedTime != nil {
		in, out := &in.LastAdmittedTime, &out.LastAdmittedTime
		*out = (*in).DeepCopy()
	}
}
...
func (in *GpuResourceRequirements) DeepCopyInto(out *GpuResourceRequirements) {
	*out = *in
	...
	if in.TotalVram != nil {
		in, out := &in.TotalVram, &out.TotalVram
		x := (*in).DeepCopy()
		*out = &x
	}
	if in.Models != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KaiwoNode) DeepCopyInto(out *KaiwoNode) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.Spec = in.Spec
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KaiwoNode.
func (in *KaiwoNode) DeepCopy() *KaiwoNode {
	if in == nil {
		return nil
	}
	out := new(KaiwoNode)
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *KaiwoNode) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KaiwoNodeList) DeepCopyInto(out *KaiwoNodeList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]KaiwoNode, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KaiwoNodeList.
func (in *KaiwoNodeList) DeepCopy() *KaiwoNodeList {
	if in == nil {
		return nil
	}
	out := new(KaiwoNodeList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *KaiwoNodeList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KaiwoNodeSpec) DeepCopyInto(out *KaiwoNodeSpec) {
	*out = *in
	out.Partitioning = in.Partitioning
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KaiwoNodeSpec.
func (in *KaiwoNodeSpec) DeepCopy() *KaiwoNodeSpec {
	if in == nil {
		return nil
	}
	out := new(KaiwoNodeSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KaiwoNodeStatus) DeepCopyInto(out *KaiwoNodeStatus) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]v1.Condition, len(*in))
	...
	in.Partitioning.DeepCopyInto(&out.Partitioning)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KaiwoNodeStatus.
func (in *KaiwoNodeStatus) DeepCopy() *KaiwoNodeStatus {
	if in == nil {
		return nil
	}
	out := new(KaiwoNodeStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NodeGpuInfo) DeepCopyInto(out *NodeGpuInfo) {
	*out = *in
	...
	if in.PhysicalCount != nil {
		in, out := &in.PhysicalCount, &out.PhysicalCount
		*out = new(int)
		**out = **in
	}
	if in.PhysicalVramPerGpu != nil {
		in, out := &in.PhysicalVramPerGpu, &out.PhysicalVramPerGpu
		x := (*in).DeepCopy()
		*out = &x
	}
	if in.LogicalVramPerGpu != nil {
		in, out := &in.LogicalVramPerGpu, &out.LogicalVramPerGpu
		x := (*in).DeepCopy()
		*out = &x
	}
	if in.IsPartitioned != nil {
		in, out := &in.IsPartitioned, &out.IsPartitioned
		*out = new(bool)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NominalResourceWrapper) DeepCopyInto(out *NominalResourceWrapper) {
	*out = *in
	if in.Actual != nil {
	...
	if in.Nominal != nil {
		in, out := &in.Nominal, &out.Nominal
		x := (*in).DeepCopy()
		*out = &x
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NominalResourceWrapper.
func (in *NominalResourceWrapper) DeepCopy() *NominalResourceWrapper {
	if in == nil {
		return nil
	}
	out := new(NominalResourceWrapper)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PartitioningConfig) DeepCopyInto(out *PartitioningConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PartitioningConfig.
func (in *PartitioningConfig) DeepCopy() *PartitioningConfig {
	if in == nil {
		return nil
	}
	out := new(PartitioningConfig)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PartitioningStatus) DeepCopyInto(out *PartitioningStatus) {
	*out = *in
	if in.AppliedProfile != nil {
		in, out := &in.AppliedProfile, &out.AppliedProfile
		*out = new(GpuPartitioningProfile)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PartitioningStatus.
func (in *PartitioningStatus) DeepCopy() *PartitioningStatus {
	if in == nil {
		return nil
	}
	out := new(PartitioningStatus)
	in.DeepCopyInto(out)
	return out
}
