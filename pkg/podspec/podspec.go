...
import (
	...
	"github.com/silogen/kaiwo/pkg/gpu"
...
func WithCommonLabels(workload api.KaiwoWorkload) PodTemplateSpecOption {
	return func(tpl *corev1.PodTemplateSpec) {
		...
		common.UpdateLabels(workload, &tpl.ObjectMeta)
	}
}
...
func WithKueueTopology(required, preferred string) PodTemplateSpecOption {
	return func(tpl *corev1.PodTemplateSpec) {
		switch {
		case required != "":
			tpl.Annotations[common.KueueRequiredTopologyKey] = required
		case preferred != "":
			tpl.Annotations[common.KueuePreferredTopologyKey] = preferred
		default:
			tpl.Annotations[common.KueuePreferredTopologyKey] = common.DefaultTopologyHostLabel
		}
	}
}
