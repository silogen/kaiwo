...
type RunStep[T any] func(context.Context, utils.KubernetesClients, *T) (StepResult, RunStep[T], error)

// RunSteps manages the step execution flow by navigating between the steps
func RunSteps[T any](ctx context.Context, clients utils.KubernetesClients, state *T, entrypoint RunStep[T]) error {
