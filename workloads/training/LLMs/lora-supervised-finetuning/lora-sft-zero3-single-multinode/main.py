# This code includes portions from distributed-workloads, licensed under the Apache License 2.0.
# See https://github.com/opendatahub-io/distributed-workloads.git for details.
...
def process_gsm8k_qa_tokens_template(dataset):
    """Processes GSM8K dataset with QA tokens template."""
    config = {
...
def main():
    ...
    data_hf_chat_template = process_gsm8k_hf_chat_template(dataset)
